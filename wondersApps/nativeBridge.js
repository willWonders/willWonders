;(function (window) {
	...
	NativeBridge.prototype.appCall = function (callAppIndex, stringResult) {
		if (this.callAppMap[callAppIndex]) {
			...
			// }
			if (regNumber.test(callAppIndex) && callAppIndex.indexOf('header') == -1) {
	...
	NativeBridge.prototype.setHeader = function (data) {
		...
		if (data.titleView.searchMethods && data.titleView.searchMethods.editingdidbegin) {
		...
		if (data.titleView.searchMethods && data.titleView.searchMethods.editingdidend) {
		...
		if (data.titleView.searchMethods && data.titleView.searchMethods.editingchanged) {
		...
		if (data.titleView.searchMethods && data.titleView.searchMethods.editingfinished) {
